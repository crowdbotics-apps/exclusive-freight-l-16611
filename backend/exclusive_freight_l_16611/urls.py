"""exclusive_freight_l_16611 URL Configuration
...
admin.site.site_header = "Exclusive Freight LLC"
admin.site.site_title = "Exclusive Freight LLC Admin Portal"
admin.site.index_title = "Exclusive Freight LLC Admin"

# swagger
schema_view = get_schema_view(
    openapi.Info(
        title="Exclusive Freight LLC API",
        default_version="v1",
        description="API documentation for Exclusive Freight LLC App",
    ),
    public=True,
